...
class TextHandler(logging.Handler):
    """Allows logging to a tkinter Text or ScrolledText widget."""
...
def append(text, record, msg):
    ...
    If the ScrolledText has a warning/error/normal tag, it will be used for nice formatting.
    """
...
class ExtendedNotebookHandler(logging.Handler):
    """Logs to an ExtendedNotebook.

    Puts all logs in the first tab and creates a tab for each additional source.
