...
from poewatcher.log import WarningFilter
    ...
    logging_options = {
        ...
        "handlers": {
            ...
            "sound_error_handler": {
                ...
                "level": "ERROR",
                "formatter": "simple",
                "sound_file": resource_string(__name__, "error.wav"),
            ...
            "sound_warning_handler": {
                ...
                "filters": ["warning"],
                "formatter": "simple",
                "sound_file": resource_string(__name__, "warning.wav"),
                "volume": float(c.get("global", "volume"))
            },
            "gui_display_handler": {
            ...
            if stripped:
                ...
                if old_gui_state != gui.isActive():
                    if gui.isActive():
                        ...
                        root.withdraw()
                # Change of state (either map started/map ended)
