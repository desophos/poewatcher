...
class PoeHandler():
    """Manages a Client.txt file.

    Reads, strips usernames from messages if needed,
    and manages poe.trade/notifier/map data export.
    """
    ...
    def __init__(self, actions, usernames, log_path):
        ...
        self.file.readline() # Read the first line
    ...
    def find_message(self, line):
        ...
        If the message can't be found, return an empty string.
        """
    ...
    def strip_username(self, line):
        ...
        Strip name (taken from self.usernames) if name is in message.
