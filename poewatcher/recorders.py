...
class GenericRecorder():
    """Simple recorder that saves to a .csv basic recording."""
...
MAP_PREFIXES = [
    "Anarchic", "Antagonist's", "Armoured", "Bipedal", "Burning", "Capricious", "Ceremonial", "Chaining", "Demonic", "Emanant",
...
MAP_SUFFIXES = [
    "of Balance", "of Bloodlines", "of Congealment", "of Deadlines", "of Desecration", "of Elemental Weakness",
    "of Endurance", "of Enfeeblement", "of Exposure", "of Flames", "of Frenzy", "of Fracturing", "of Giants", "of Hemomancy",
    "of Ice", "of Insulation", "of Lightning", "of Power", "of Smothering", "of Stasis", "of Temporal Chains", "of Venom",
    "of Vulnerability", "of Commanders", "of Hordes", "of Suffering", "of the Warlord"
]


class MapRecorder():
    """Manager that creates/destroys/edits a new Map object based on user input.
    ...
    def map_data_from_clipboard(self, msg, char_name):
        """Return a Map; try to use information in clipboard.

        Will not work with clipboard information not conformant to PoE clipboard data.
        """
        ...
        if info.startswith("Rarity:") and "Travel to this Map by using it in the Eternal Laboratory" in info:
            ...
            tmp = Map.from_raw_data(
                char_name, level, psize, quantity,
    ...
    def map_data_from_user_input(self, msg, char_name):
        ...
        tmp = Map.from_raw_data(
            char_name, info[0], info[1], info[2],
    ...
    def edit_map(self, msg):
        ...
        NOTE: Erase old data if new corresponding data is inputed.
        """
    ...
    def add_loot(self, msg):
        ...
        if len(self.data) > 0:
            # Remove non-digit character & cast everything to int
    ...
    def end_map(self, msg):
        ...
        Optionally sends data to server.
        """
        if len(self.data) > 0:
    ...
    def send_map(self, data):
        ...
        If the server can't be reached, save data to a separate file instead.
        """
        csv = data.to_csv()
